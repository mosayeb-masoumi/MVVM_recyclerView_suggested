package com.example.mvvm_recyclerview_suggested.view.adapter;
...
import com.example.mvvm_recyclerview_suggested.databinding.ItemUserBinding;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.CustomHolder> {
    ...
    public UserAdapter(ArrayList<UserViewModel> arrayList, Context context) {
